...
<!--                                         <button class="btn btn-primary ti-pencil" 
                                                data-toggle="modal" 
                                                data-target="#editAcaraModal" 
                                                data-id="<?= $event->id_history ?>"
                                                data-nama="<?= $event->nama_acara ?>"
                                                data-tanggal="<?= $event->tanggal_acara ?>"
                                                data-status="<?= $event->status ?>"
                                                data-toggle="tooltip"
                                                data-placement="top"
                                                title="Edit">
                                        </button> -->
                                        <a href="<?= base_url('Home/hapus_history/'.$event->id_history) ?>">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editAcaraModalLabel">Edit History</h5>
                    <button type="button" class="btn btn-close" data-dismiss="modal" aria-label="Close">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="editAcaraForm" action="<?= base_url('Home/aksi_edit_history') ?>" method="POST">

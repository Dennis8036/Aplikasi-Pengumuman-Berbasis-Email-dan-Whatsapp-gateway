                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title"></h4>
                                ...
                                <form action="<?= base_url('Home/aksi_t_kelas') ?>" method="POST" enctype="multipart/form-data">


<div class="form-group row">
    <label for="inputText" class="col-sm-2 col-form-label">Nama Kelas</label>
    <div class="col-sm-10">
        <input type="text" id="" placeholder="Nama Kelas" class="form-control" name="nk" required>
    </div>
</div>

...
{ 
        protected $table = 'tb_kamar'; // atau nama tabel yang sesuai
    protected $primaryKey = 'id_kamar';
    
    // Tambahkan allowed fields
    protected $allowedFields = [
        ...
        'tgl_klr',
        'total_bayar',
        'status_kamar' // jika ingin mengupdate status_kamar di tb_kamar
    ];

    // Tambahan: bisa juga tambahkan fungsi untuk melakukan update
    public function updateKamar($data, $where)
    {
    ...
    public function getTotalPengeluaran()
{
    ...
    public function clear_table($table) {
        $this->db->table($table)->emptyTable(); // Menghapus semua data dari tabel
    }
